...
app.directive('navbarBottom', function() {
	return {
		restrict: 'EA',
		template: `
			<nav class="navbar navbar-fixed-bottom fixed-bottom bg-white navbar-light border-top-purple" ng-controller="ctrlzonatech">
...
app.directive('navbarTop', function() {
	return {
		restrict: 'EA',
		template: `
			<nav class="navbar navbar-fixed-top fixed-top navbar-purple bg-purple" ng-controller="ctrlzonatech">
...
// End Config
// Controller
app.controller('ctrlzonatech', function($scope,$location) {
